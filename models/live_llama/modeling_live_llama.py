...
from transformers import LlamaConfig, LlamaModel as LlamaModelBase, LlamaForCausalLM as LlamaForCausalLMBase
from transformers.activations import GELUActivation
from transformers.utils import logging
from transformers.modeling_outputs import BaseModelOutputWithPast as BaseModelOutputWithPastBase, CausalLMOutputWithPast as CausalLMOutputWithPastBase
...
@dataclass
class BaseModelOutputWithPast(BaseModelOutputWithPastBase):
...
class LlamaDecoderLayer(LlamaDecoderLayerBase):
    def __init__(self, config: LlamaConfig, layer_idx: int):
        super().__init__(config=config, layer_idx=layer_idx)
        self.layer_idx = layer_idx
        self.is_return_vision_weights = config.is_return_vision_weights
        self.frame_num_tokens = config.frame_num_tokens
